...
def check2():
    ...
    g_algo.save_to_json("C:\\json_file\\stam.json")
...
def my_check():
    lis=[]
    com = comperator.comperator()
    print("10")
    lis += (["  10 v graph:"])
    lis += [com.tester("C:\\json_file\\G_10_80_1.json")]
    print("100")
    lis += (["  100 v graph:"])
    lis += [com.tester("C:\\json_file\\G_100_800_1.json")]
    print("1000")
    lis += (["  1000 v graph:"])
    lis += [com.tester("C:\\json_file\\G_1000_8000_1.json")]
    print("10000")
    lis += (["  10000 v graph:"])
    lis += [com.tester("C:\\json_file\\G_10000_80000_1.json")]
    print("20000")
    lis += (["  20000 v graph:"])
    lis += [com.tester("C:\\json_file\\G_20000_160000_1.json")]
    print("30000")
    lis += (["  30000 v graph:"])
    lis += [com.tester("C:\\json_file\\G_30000_240000_1.json")]
    #com.tester2("C:\\Users\\shpit\\PycharmProjects\\Ariel_OOP_2020\\Assignments\\Ex3\\G_30000_240000_0.json")
    print(lis)
