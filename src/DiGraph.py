...
class DiGraph(GraphInterface):
    ...
    def __init_copy__(self, other=GraphInterface()):
        self = other
    ...
    def remove_edge(self, node_id1: int, node_id2: int) -> bool:
        ...
        """
        if (node_id1 in self.nodes.keys()) & (node_id2 in self.nodes.keys()):
            if self.go[node_id1].get(node_id2) is not None:
    ...
    def __repr__(self):
        return "Graph: |V|=" + str(self.v_size()) + " , |E|=" + str(self.edges)
